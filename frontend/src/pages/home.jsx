    ...
    <div className="min-h-screen flex flex-col justify-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <Card>
            <CardContent>
              <CropIcon className="w-16 h-16 mb-4 text-black" />
              <h2 className="font-semibold text-lg text-black">Agriculture</h2>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              <CurrencyIcon className="w-16 h-16 mb-4 text-black" />
              <h2 className="font-semibold text-lg text-black">Public Finance</h2>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              <SchoolIcon className="w-16 h-16 mb-4 text-black" />
              <h2 className="font-semibold text-lg text-black">Education</h2>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              <ALargeSmallIcon className="w-16 h-16 mb-4 text-black" />
              <h2 className="font-semibold text-lg text-black">Small Town Development</h2>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              <RulerIcon className="w-16 h-16 mb-4 text-black" />
              <h2 className="font-semibold text-lg text-black">Rule of Law</h2>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              <LandmarkIcon className="w-16 h-16 mb-4 text-black" />
              <h2 className="font-semibold text-lg text-black">Local Government</h2>
            </CardContent>
          </Card>
          <Card>
            <CardContent>
              <VoteIcon className="w-16 h-16 mb-4 text-black" />
              <h2 className="font-semibold text-lg text-black">Electoral Reforms</h2>
            </CardContent>
          </Card>
        </div>
      </div>
...
function ALargeSmallIcon(props) {
  return (
    <svg
      {...props}
